...
insert into auth.users (instance_id, id, aud, role, email) values
  ('00000000-0000-0000-0000-000000000000','cccccccc-0000-0000-0000-000000000001',
   'authenticated','authenticated','passenger.c@test.local'),
  ('00000000-0000-0000-0000-000000000000','cccccccc-0000-0000-0000-000000000002',
   'authenticated','authenticated','passenger.d@test.local'),
...
insert into public.profiles (id, role, first_name, phone) values
  ('cccccccc-0000-0000-0000-000000000001','passenger','Aline','+250788000201'),
  ('cccccccc-0000-0000-0000-000000000002','passenger','Bosco','+250788000202'),
  ('cccccccc-0000-0000-0000-000000000003','rider','Eric','+250788000203');
...
select lives_ok(
  ...
  'a passenger creates a trip from their own live quote'
);

select is(
  (select state::text from public.trips
    where passenger_id = 'cccccccc-0000-0000-0000-000000000001' limit 1),
  'requested',
...
select throws_ok(
  $$ select public.create_trip_from_quote(
       ...
       st_point(30.0588,-1.9536)::geography, 'B') $$,
  '42501', null,
  'a passenger cannot create a trip from someone else quote'
);

select ok(
  not has_function_privilege('authenticated',
    'public.assign_rider_to_trip(uuid,uuid,text)', 'EXECUTE'),
  'a passenger cannot assign themselves a rider'
);

select ok(
  has_function_privilege('service_role',
    'public.assign_rider_to_trip(uuid,uuid,text)', 'EXECUTE'),
  'the dispatcher can assign a rider'
);
