...
select ok(not has_function_privilege('authenticated',
    'public.credit_rider_wallet(uuid,integer,text)', 'EXECUTE'),
...
select throws_ok(
  $$select public.credit_rider_wallet('11111111-1111-1111-1111-111111111111'::uuid, 5000, '')$$,
  '22023', null,
  'a wallet credit without a reference is refused');

select throws_ok(
  $$select public.credit_rider_wallet('11111111-1111-1111-1111-111111111111'::uuid, -100, 'x')$$,
  '22023', null,
