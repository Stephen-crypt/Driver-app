...
insert into auth.users (instance_id, id, aud, role, email) values
  ('00000000-0000-0000-0000-000000000000',
   ...
   'authenticated', 'authenticated', 'ledger.rider@test.local');

insert into public.profiles (id, role, first_name, phone)
values ('dddddddd-0000-0000-0000-000000000001', 'rider', 'Eric', '+250788000111');
...
select throws_ok(
  $$ update public.ledger_entries set amount_rwf = 1
      where rider_id = 'dddddddd-0000-0000-0000-000000000001' $$,
  '42501', null,
